<template>
  <div
    v-if="show"
    ref="root"
    class="border-dark-800 bg-dark-900 fixed z-10 w-56 space-y-2 rounded-md border p-4 text-sm text-gray-300 shadow-md"
    @mouseup.stop
  >
...
import { CallStreamType } from "@/src/global/constants";
